...
namespace MeetingRoomScheduler.API.Validators
{
    public class EmailValidator
    {
        ...
        private readonly Regex regex = new Regex(EMAIL_PATTERN);

        public bool IsMatch(string email)
        {
            return regex.IsMatch(email);
        }
        public bool AllMatch(IEnumerable<string> emails)
        {
            return emails.All(x => IsMatch(x));
        }
    }
}
